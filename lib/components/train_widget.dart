              ...
              Row(
                ...
                children: [
                  ...
                  FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent('TRAIN_COMP_close_ICON_ON_TAP');
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: InkWell(
                                onTap: () async {
                                  logFirebaseEvent(
                                      'TRAIN_COMP_Container_betg5o7j_ON_TAP');
                                  logFirebaseEvent(
                                ...
                                child: StreamBuilder<ActionCacheRecord>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return InkWell(
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'TRAIN_COMP_iconBut_ON_TAP');
                                        logFirebaseEvent(
                                            'iconBut_Update-Local-State');
                                        setState(
