              ...
              Row(
                ...
                children: [
                  ...
                  FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent('CHEESE_COMP_close_ICON_ON_TAP');
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: InkWell(
                          onTap: () async {
                            logFirebaseEvent(
                                'CHEESE_COMP_Container_2hexlcd0_ON_TAP');
                            logFirebaseEvent('iconButton_Update-Local-State');
