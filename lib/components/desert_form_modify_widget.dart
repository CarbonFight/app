...
class DesertFormModifyWidget extends StatefulWidget {
  const DesertFormModifyWidget({
    Key key,
    this.typeCache,
  }) : super(key: key);
  ...
  @override
  _DesertFormModifyWidgetState createState() => _DesertFormModifyWidgetState();
}

class _DesertFormModifyWidgetState extends State<DesertFormModifyWidget> {
