...
class ElectricityFormActionModifyWidget extends StatefulWidget {
  const ElectricityFormActionModifyWidget({
    Key key,
    this.typeCache,
  }) : super(key: key);
  ...
  @override
  _ElectricityFormActionModifyWidgetState createState() =>
      _ElectricityFormActionModifyWidgetState();
}

class _ElectricityFormActionModifyWidgetState
    extends State<ElectricityFormActionModifyWidget> {
