...
class WaterFormActionModifWidget extends StatefulWidget {
  const WaterFormActionModifWidget({
    Key key,
    this.typeCache,
  }) : super(key: key);
  ...
  @override
  _WaterFormActionModifWidgetState createState() =>
      _WaterFormActionModifWidgetState();
}

class _WaterFormActionModifWidgetState
    extends State<WaterFormActionModifWidget> {
