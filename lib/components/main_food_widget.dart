...
class MainFoodWidget extends StatefulWidget {
  const MainFoodWidget({
    Key key,
    this.cache,
  }) : super(key: key);
  ...
  @override
  _MainFoodWidgetState createState() => _MainFoodWidgetState();
}

class _MainFoodWidgetState extends State<MainFoodWidget> {
              ...
              Row(
                ...
                children: [
                  ...
                  FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent('MAIN_FOOD_COMP_close_ICON_ON_TAP');
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: InkWell(
                          onTap: () async {
                            logFirebaseEvent(
                                'MAIN_FOOD_COMP_Container_4dmfdd7n_ON_TAP');
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: InkWell(
                          onTap: () async {
                            logFirebaseEvent(
                                'MAIN_FOOD_COMP_Container_eeuahel8_ON_TAP');
                            logFirebaseEvent('iconButton_Update-Local-State');
