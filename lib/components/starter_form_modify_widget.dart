...
class StarterFormModifyWidget extends StatefulWidget {
  const StarterFormModifyWidget({
    Key key,
    this.typeCache,
  }) : super(key: key);
  ...
  @override
  _StarterFormModifyWidgetState createState() =>
      _StarterFormModifyWidgetState();
}

class _StarterFormModifyWidgetState extends State<StarterFormModifyWidget> {
                        ...
                        children: [
                          Padding(
                            ...
                            child: FlutterFlowRadioButton(
                              options:
                                  ['Végétarienne', 'Mixte', 'Viande'].toList(),
                              onChanged: (value) {
