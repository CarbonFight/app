...
class MotoWidget extends StatefulWidget {
  const MotoWidget({
    Key key,
    this.cache,
  }) : super(key: key);
  ...
  @override
  _MotoWidgetState createState() => _MotoWidgetState();
}

class _MotoWidgetState extends State<MotoWidget> {
              ...
              Row(
                ...
                children: [
                  ...
                  FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent('MOTO_COMP_close_ICON_ON_TAP');
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: InkWell(
                                onTap: () async {
                                  logFirebaseEvent(
                                      'MOTO_COMP_Container_q5bwk294_ON_TAP');
                                  logFirebaseEvent(
                                      'iconButton_Update-Local-State');
                                  setState(() => FFAppState().actionCO2 = 1);
                                },
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: InkWell(
                                onTap: () async {
                                  logFirebaseEvent(
                                      'MOTO_COMP_Container_j0quwro3_ON_TAP');
                                  logFirebaseEvent(
                                      'iconButton_Update-Local-State');
