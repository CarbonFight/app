...
class BreadFormModifyWidget extends StatefulWidget {
  const BreadFormModifyWidget({
    Key key,
    this.typeCache,
  }) : super(key: key);
  ...
  @override
  _BreadFormModifyWidgetState createState() => _BreadFormModifyWidgetState();
}

class _BreadFormModifyWidgetState extends State<BreadFormModifyWidget> {
  bool deleteValue;
  int portionsValue;
                            ...
                            child: InkWell(
                              onTap: () async {
                                ...
                                setState(() => FFAppState().actionCO2 =
                                    functions.foodActionsCO2e('bread', 'null',
                                        'null', portionsValue));
