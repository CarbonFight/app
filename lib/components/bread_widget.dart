...
class BreadWidget extends StatefulWidget {
  const BreadWidget({
    Key key,
    this.cache,
  }) : super(key: key);
  ...
  @override
  _BreadWidgetState createState() => _BreadWidgetState();
}

class _BreadWidgetState extends State<BreadWidget> {
  int portionsValue;
              ...
              Row(
                ...
                children: [
                  ...
                  FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent('BREAD_COMP_close_ICON_ON_TAP');
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: InkWell(
                          onTap: () async {
                            logFirebaseEvent(
                                'BREAD_COMP_Container_8qvy7e1o_ON_TAP');
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: InkWell(
                          onTap: () async {
                            logFirebaseEvent(
                                'BREAD_COMP_Container_uu2wq5ud_ON_TAP');
                            logFirebaseEvent('iconButton_Update-Local-State');
