...
class CoffeeFormModifyWidget extends StatefulWidget {
  const CoffeeFormModifyWidget({
    Key key,
    this.typeCache,
  }) : super(key: key);
  ...
  @override
  _CoffeeFormModifyWidgetState createState() => _CoffeeFormModifyWidgetState();
}

class _CoffeeFormModifyWidgetState extends State<CoffeeFormModifyWidget> {
                                ...
                                valueOrDefault<String>(
                                  '+ ${valueOrDefault<String>(
                                    functions.printScore(
                                        containerFoodActionsRecord.co2e),
                                    '0',
                                  )}',
                                  '+ 0 g',
                                ),
                          ...
                          children: [
                            Container(
                              ...
                              child: FlutterFlowCountController(
                                ...
                                count: portionsValue ??=
                                    containerFoodActionsRecord.portions,
                                updateCount: (count) =>
