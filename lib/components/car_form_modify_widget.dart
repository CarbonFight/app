...
class CarFormModifyWidget extends StatefulWidget {
  const CarFormModifyWidget({
    Key key,
    this.typeAction,
  }) : super(key: key);

  final ActionTypeCacheRecord typeAction;

  @override
  _CarFormModifyWidgetState createState() => _CarFormModifyWidgetState();
}

class _CarFormModifyWidgetState extends State<CarFormModifyWidget> {
      ...
      child: StreamBuilder<List<TransportActionsRecord>>(
        stream: queryTransportActionsRecord(
          queryBuilder: (transportActionsRecord) => transportActionsRecord
              ...
              .where('created_time', isEqualTo: widget.typeAction.date),
          singleRecord: true,
        ),
