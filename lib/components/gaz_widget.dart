...
class _GazWidgetState extends State<GazWidget> {
              ...
              Row(
                ...
                children: [
                  ...
                  FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent('GAZ_COMP_close_ICON_ON_TAP');
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: InkWell(
                                onTap: () async {
                                  logFirebaseEvent(
                                      'GAZ_COMP_Container_m26bvhbn_ON_TAP');
                                  logFirebaseEvent(
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: InkWell(
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'GAZ_COMP_Container_mkjajg0i_ON_TAP');
                                    logFirebaseEvent(
                                        'iconButton_Update-Local-State');
                                    setState(() => FFAppState().actionCO2 =
                                        functions.energyPeriodicsCO2e(
