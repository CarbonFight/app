...
class BikeFormModifyWidget extends StatefulWidget {
  const BikeFormModifyWidget({
    Key key,
    this.typeCache,
  }) : super(key: key);
  ...
  @override
  _BikeFormModifyWidgetState createState() => _BikeFormModifyWidgetState();
}

class _BikeFormModifyWidgetState extends State<BikeFormModifyWidget> {
