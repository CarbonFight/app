                                                                ...
                                                                Expanded(
                                                                  child: Align(
                                                                    ...
                                                                    child:
                                                                        Stack(
                                                                      children: [
                                                                        if ((pageView2ActionCacheRecord.date) !=
                                                                            (getCurrentTimestamp))
                                                                          Align(
                                                                            alignment:
                                                                                AlignmentDirectional(0, 0),
                                                                  ...
                                                                  StreamBuilder<
                                                                    ...
                                                                    stream:
                                                                      ...
                                                                      queryBuilder: (transportActionsRecord) => transportActionsRecord
                                                                          ...
                                                                          .where(
                                                                              'created_time',
                                                                              isEqualTo: pageView2ActionCacheRecord.date),
                                                                    ),
                                                                    builder:
                                                                        (context,
                                                                            snapshot) {
                                                                      ...
                                                                      return Row(
                                                                        ...
                                                                        children: List.generate(
                                                                            row1TransportActionsRecordList.length,
                                                                            (row1Index) {
                                                                          final row1TransportActionsRecord =
                                                                              row1TransportActionsRecordList[row1Index];
                                                                          return Stack(
                                                                            children: [
                                                                              if ((row1TransportActionsRecord.transport) == 'train')
                                                                                InkWell(
                                                                                  onTap: () async {
