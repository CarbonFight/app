...
class _AccountWidgetState extends State<AccountWidget> {
  ...
  void initState() {
    ...
    _model.sponsorController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.sponsor, ''));
                            ...
                            child: Padding(
                              ...
                              child: AuthUserStreamWidget(
                                builder: (context) => SizedBox(
                                  width: 300.0,
                                  child: TextFormField(
                                    controller: _model.sponsorController,
                                    ...
                                    style:
                                        FlutterFlowTheme.of(context).bodyMedium,
                                    validator: _model.sponsorControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ),
                                ...
                                children: [
                                  ...
                                  AuthUserStreamWidget(
                                    builder: (context) => SelectionArea(
                                        child: Text(
                                      valueOrDefault(
                                          currentUserDocument?.sponsorshipCode,
                                          ''),
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                await currentUserReference!
                                  ...
                                  sponsor: _model.sponsorController.text,
                                  displayName:
